...
var prbs_autovr0=1,prbs_autovr1=1,prbs_autovr2=1,prbs_autovr3=1, page_act="index";
var dataset=-1;
var outAmpl0=0.3,outAmpl1=0.3,outAmpl2=0.3,outAmpl3=0.3;
...
var myVarTX_eml_test=new Array("emlAmp1.vg1","emlAmp2.vg1","emlAmp3.vg1","emlAmp0.vg1",
			 "emlAmp1.vg2","emlAmp2.vg2","emlAmp3.vg2","emlAmp0.vg2",
                         "bert0.L0.txaSwingFine", "bert0.L1.txaSwingFine", "bert0.L2.txaSwingFine", "bert0.L3.txaSwingFine",
			 ...
			 "bert0.L0.swapTxPN","bert0.L1.swapTxPN","bert0.L2.swapTxPN","bert0.L3.swapTxPN",
                         "bert0.dataSetDescription");
var myVarTX_eml_test0= new Array("vg1","vg2","vd1","vd2");
var myVarTX_eml_test2= new Array("txaSwingFine","swapTxPN","txaSwing","swapTxPN","txaEqpst");
var myVarTX= new Array(
			 "emlAmp1.vg2","emlAmp2.vg2","emlAmp3.vg2","emlAmp0.vg2",
			 "bert0.L0.swapTxPN","bert0.L1.swapTxPN","bert0.L2.swapTxPN","bert0.L3.swapTxPN","bert0.dataSetDescription");
var myVarTX0 = new Array("vg2");
var myVarTX2 = new Array("swapTxPN");
var myVarDrTr = new Array("ptrig0.pattern","bert0.bitrate");
var myVarErr = new Array(
...
var myVarSystem= new Array("fanco.fan0.rpm","fanco.fan1.rpm","fanco.fan2.rpm","system.latchedFault",
                             "system.firmware","system.ip","system.netmask","system.mac","system.gateway","system.temp","amp.temp","system.variant","system.hwRevision");
var myVarGraph= new Array("tx0.pwr","tx1.pwr","tx2.pwr","tx3.pwr");
...
console.log("data:"+evt.data);
          if (evt.data.substr(2, 3)=="ack" || evt.data.substr(2, 3)=="nak") { return;}
          ...
          if ((item.substr(0, 3)=="amp" && item!="amp.temp") || item.substr(4, 3)=="pwr") {
               value=Math.round(value * 100) / 100;
               if (value>10) {
                    value='>10';    
               }
...
$(document).ready(function()
{
	...
	$( "#SystemBut" ).click(function() {
        ...
        $( "#EMLTXTestBut" ).click(function() {
		myElement=myVarTX_eml_test;
                n=2;
                page_k=0;
                all=all_tx;
                page_act="EMLTXTest"
		laodpage("admin/tx_eml_calibr.html","#frame");
		return false;
	});
