...
typedef void PVar_SetCallback (void *clientData,uint32_t adId, const char *strP);
typedef void PVar_GetCallback (void *clientData,uint32_t adId, char *bufP,uint16_t maxlen);
