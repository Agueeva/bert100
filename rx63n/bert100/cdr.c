...
void
iShuffleRead(uint16_t * uOutp, uint16_t uInp, uint8_t uStartBit, uint8_t uNumBit)
{
	uint16_t uMask = 0;
	volatile uint8_t i;
...
void
iShuffle(uint16_t * uOutp, uint16_t uInp, uint8_t uStartBit, uint8_t uNumBit, uint8_t uNumber)
{
	uint16_t uMask = 0;
	volatile uint8_t i;
	if (uStartBit + uNumBit > 16) {
...
void
Cdr_Read_Part(uint16_t * uOutp, uint16_t phy_addr, uint16_t uRegister, uint8_t uNumBit, uint8_t uStartBit)
{
	uint16_t uVal;
	uVal = Cdr_Read(phy_addr, uRegister);
