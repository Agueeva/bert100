...
class MyFrame(wx.Frame):
    def __init__(self, parent, id, title, system):
        ...
        #nextTab = 'IPBER Tool'
        #self.ipBERPanel = ipBER.BERPanel(self.notebook, -1)
        #self.notebook.AddPage(self.ipBERPanel,nextTab)        

        #nextTab = 'IPBER_Optical Tool'
        #self.ipBERPanel_optical = ipBER_optical.BERPanel(self.notebook, -1)
        #self.notebook.AddPage(self.ipBERPanel_optical,nextTab)              
