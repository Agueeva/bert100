    ...
    def Do(self):     
        ...
        if self.controls.cbMode['Live Height'].Value: 
          ...
          if self.controls.cbMode['Fast Diamond'].Value:
              ...
              self.DoVerticalStepsF(self.controls,range(128+self.saOffset,256),0,forceFull=True)
              self.DoVerticalStepsF(self.controls,range(128+self.saOffset,0,-1),0,forceFull=True)
